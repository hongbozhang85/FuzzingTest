...
ALGORITHMS = list(NAIVE, OPTIMAL, BAYES, EPSILON)
...
if (makeplots) {
    ...
    ## ONE
    png("slide3.png",width=900,height=600)
    lads = c("0","20", "40", "60", "80", "100")
    ft = c(0,20000,40000,60000,80000,100000)
    plot(RESULTS[[1]][1,],
         type='l',
         col = "white",
         main = "Fuzzer Response: n -> infinity",
    ...
    legend(x="topleft", algnames, col=colours, text.col=colours, pch=NA, lwd=4, cex = 1.5)
    grid()
